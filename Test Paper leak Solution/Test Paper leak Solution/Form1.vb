...
Public Class Form1
    ...
    Private Sub Form1_Load(sender As Object, e As EventArgs) Handles MyBase.Load
        ...
        '위치 지정
        Location = New Point(System.Windows.Forms.Screen.PrimaryScreen.Bounds.Width() * 0.2, System.Windows.Forms.Screen.PrimaryScreen.Bounds.Height() * 0.35)
        '공지사항 지정
        Label1.Text =
            "1. 다른이름으로 파일이 저장되지 않습니다." & vbCrLf &
            "2. 파일은 암호화 되어 저장됩니다." & vbCrLf &
            "3. 파일 열기는 이 솔루션으로만 가능합니다." & vbCrLf &
            "" & vbCrLf &
            "문의" & vbCrLf &
            "" & vbCrLf &
            "제 작  : P.K Team" & vbCrLf &
            "e-mail : hdh0926@naver.com"
        '솔루션 훼손 여부 점검
